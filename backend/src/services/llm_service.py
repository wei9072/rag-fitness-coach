...
class LLMService:
    ...
    def generate_reply(self, question: str, context_chunks: list[str], chat_history: str = "", api_key: str = None, is_paid: bool = False, user_profile: str = None, llm_provider: str = "groq", model_name: str = None, intent_category: str = "QA_INTENT") -> str:
        """
        ...
        if chat_history:
            dynamic_system_prompt += f"\n\n### 近期對話語境 (Context)：\n以下為你與使用者最近的交談紀錄。針對省略的主詞或代名詞，請優先參考此區段：\n{chat_history}"
